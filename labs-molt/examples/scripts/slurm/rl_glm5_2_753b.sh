...
# training recompute. The bf16 default rounds per token across a long rollout,
# so rollout log-probs drift from training and vllm_kl climbs with steps.
